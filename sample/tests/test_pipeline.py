...
class PipelineTests(unittest.TestCase):
    ...
    def test_dynamic_pipeline_generates_frida_script(self) -> None:
        ...
        # Frida 17.x compatible API (was Module.findBaseAddress in older versions)
        self.assertIn("Process.getModuleByName", script)
        self.assertIn("mod.base", script)
        ...
        # Sig fallback uses synchronous scan (was async Memory.scan with broken trigger)
        self.assertIn("Memory.scanSync", script)
        self.assertIn("sigMatchesAt", script)
